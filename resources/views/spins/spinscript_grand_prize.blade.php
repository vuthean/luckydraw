<script>
    ...
    function getWinner() {
        $.ajax({
            type: "get",
            url: "{{ route('spin/winner/grand-prize') }}",
...
<script type="text/javascript">
    ...
    $('#btn-example10-start').click(function() {
        if ($(this).html() == 'Start') {
            ...
            $.ajax({
                url: "tickets/get-random-grand-prize-ticket",
                type: 'get',
                dataType: 'json',
                success: function(response) {
                    ...
                    var customer_CIF = response['customer_cif_number'];
                    ...
                    var ticket_number = response['number'];
                    ...
                    $.ajax({
                        type: "get",
                        url: "winner/grand-prize-ticket/"+ticket_id,
