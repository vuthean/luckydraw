...
<body style="background: url({{URL::to('src/image/new_luckyDraw/Background/Lucky-Draw-BG.png')}});">
    ...
    <header style="padding:0;margin: 0;" class="jumbotron bg-cover text-white">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                <img src="{{URL::to('src/image/new_luckyDraw/Prize/EV-Bike.png')}}" class="prize-winner" id="prize_image">
            </div>
        </div>
    </header>
                ...
                <div class="row">
                    <div class="col-md-12 d-flex flex-column justify-content-center" style="background: linear-gradient(220deg, rgb(255 255 255 / 28%) 0%, rgb(255 255 255 / 28%) 100%); height: 400px;border-radius: 25px;">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-2 text-center d-flex align-items-center justify-content-center" style="height: auto;min-height: 50px; word-break: break-word; border-radius: 50px; margin: 0 15px; padding: 10px;">
                                <span id="" style="color:#ffffff;font-size: 33px;font-family: Bayon-Regular;"><i>ឈ្នោះអាជីវកម្ម</i></span>
                            </div>
                            <div class="col-sm-2  text-center d-flex align-items-center justify-content-center" style="background: linear-gradient(220deg, #9d52fe 0%, #6220fb 100%);height: auto;min-height: 50px; word-break: break-word; border-radius: 50px; margin: 0 15px; padding: 10px;">
                        ...
                        <div class="row justify-content-center" style="margin-top: 5px;">
                            <div class="col-sm-2 text-center d-flex align-items-center justify-content-center" style=" height: 50px;border-radius: 50px; margin: 0 15px;">
                                <span id="" style="color:#ffffff; font-family: Bayon-Regular;"><i>លេខប័ណ្ណចាប់រង្វាន់</i></span>
                            </div>
                            <div class="col-sm-2 text-center d-flex align-items-center justify-content-center" style="background: #ffffff; border:solid 3px #ffffff; height: 50px;border-radius: 50px; margin: 0 15px;">
                         ...
                         <div class="row justify-content-center" style="margin-top: 5px;">
                            <div class="col-sm-2 text-center d-flex align-items-center justify-content-center" style=" height: 50px;border-radius: 50px; margin: 0 15px;">
                                <span id="" style="color:#ffffff; font-family: Bayon-Regular;"><i>លេខទូរសព្ទ</i></span>
                         ...
                         <div class="row justify-content-center" style="margin-top: 5px;">
                            <div class="col-sm-2 text-center d-flex align-items-center justify-content-center" style=" height: 50px;border-radius: 50px; margin: 0 15px;">
                                <span id="" style="color:#ffffff; font-family: Bayon-Regular;"><i>លេខគណនី</i></span>
                            </div>
                            <div class="col-sm-2 text-center d-flex align-items-center justify-content-center" style="background: #ffffff; border:solid 3px #ffffff; height: 50px;border-radius: 50px; margin: 0 15px;">
        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-center">All winners are reach our limitation of 3.</p>
                </div>
    ...
    @include('spins/script/spinscript_motor_prize')
</body>
</html>
