...
<body style="background: url({{URL::to('src/image/new_luckyDraw/Background/Lucky-Draw-BG.png')}});">
    ...
    <header style="padding:0;margin: 0;" class="jumbotron bg-cover text-white">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-6">
                <img src="{{URL::to('src/image/new_luckyDraw/Prize/Money.png')}}" class="prize-winner" id="prize_image">
            </div>
        </div>
    </header>
        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-center">All winners are reach our limitation of 30.</p>
                </div>
    ...
    @include('spins/script/spinscript_cash_prize')
</body>
</html>
